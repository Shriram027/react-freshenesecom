    ...
    <div className='flex mt-6'>
        <div className='flex  md:col-12 mr-4'>
            <div className='md:col-3'>
                ...
                <div className="flex">
                    <ul>
                        <li className='mt-2 text-green-400'>Carrot</li>
                        <li className='mt-2 text-green-400'>Tomatoes</li>
                        <li className='mt-2 text-green-400'>Potatoes</li>
                        <li className='mt-2 text-green-400'>Chicken</li>
                        <li className='mt-2 text-green-400'>Pork</li>
                        <li className='mt-4 dropdown'>
                            <button type="button" className="btn dropdown-toggle" data-bs-toggle="dropdown">
                                More products
                            </button>
                            <ul className="dropdown-menu">
                                <li className="dropdown-item text-green-400">Cotton</li>
                                <li className="dropdown-item text-green-400">Flowers</li>
                                <li className="dropdown-item text-green-400">Woods</li>
                            </ul>
                        </li>
                    </ul>
                </div>
